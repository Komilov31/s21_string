...
START_TEST(test_specifier_x_X) {
  const char *formats[] = {"%x",     "%#x",     "%-10x",   "%010lx",
                           "%10.5x", "%#10.5x", "%X",      "%#X",
                           "%-10lX", "%010X",   "%-#10.5x"};
...
START_TEST(test_specifier_g) {
  const char *formats[] = {"% .2Lg", "%+.7g", "%- 30.15LG"};
  long double values[] = {0.0034384, 156.25378, 0.1};
...
START_TEST(test_specifier_e) {
  const char *formats[] = {"% .2Le", "% 2E", "%+30.15Le"};
  long double values[] = {0.0034384, 156.25378,      253.234,    34234.867,
                          3.23232,   -INFINITY,      12342.2323, NAN,
                          -NAN,      INFINITY,       -0,         -2.0,
                          -0.0,      0.0000000000034};
...
START_TEST(test_specifier_f) {
  const char *formats[] = {"%030.15Lf", "%#.2Lf", "%+30.15Lf"};
  long double values[] = {0.0034384, 156.25378,      253.234,    34234.867,
                          3.23232,   -INFINITY,      12342.2323, NAN,
                          -NAN,      INFINITY,       -0,         -2.0,
                          -0.0,      0.0000000000034};
